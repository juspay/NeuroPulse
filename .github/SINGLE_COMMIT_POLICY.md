...
> Guidelines for maintaining clean commit history in ai-agent

## Overview

This document outlines the single commit policy for the ai-agent repository to ensure a clean, readable, and maintainable git history.
...
```bash
# Via GitHub CLI
gh api repos/juspay-maintainers/ai-agent \
  --method PATCH \
...
- Issues: https://github.com/juspay/ai-agent/issues
