...
> Guidelines for setting up branch protection rules for ai-agent

## Overview

This document outlines the recommended branch protection settings for the ai-agent repository to ensure code quality and security.
...
gh api repos/juspay-maintainers/ai-agent/branches/main/protection \
  --method PUT \
